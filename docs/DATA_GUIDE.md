...
| `REAL_REQUIREMENTS` in `requirements.mjs` | Four selected source-backed routes with dates, thresholds and citations. Do not add or change legal conditions without source verification. |
