...
for(const name of ['index.html','assets/app.mjs','assets/core.mjs','assets/styles.css','assets/demo.css','assets/demo-core.mjs','assets/demo-views.mjs','data/client-demo.mjs','data/records.json']){
