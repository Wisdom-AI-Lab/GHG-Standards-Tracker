...
PAGES.workspace=['Client workspace','Explore organisational evidence, reporting boundaries and illustrative applicability scenarios.'];
...
export async function start(){
  ...
  const route=()=>Object.hasOwn(PAGES,location.hash.slice(1))?location.hash.slice(1):'overview';
  ...
  $('view').addEventListener('change',event=>{
    ...
    const actions={'demo-date':'date','demo-boundary':'boundary','demo-entity':'entity','demo-jurisdiction':'jurisdiction'};
